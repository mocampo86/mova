...
| --- | --- | --- |
| `/` | Public landing page with a sports image carousel hero, Mova's value proposition, a player guide for finding and booking a court, player and owner audience sections, featured active complexes, and sign-in call to action. | Public |
