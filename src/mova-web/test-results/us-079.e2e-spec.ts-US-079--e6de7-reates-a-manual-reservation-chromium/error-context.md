...
- Name: us-079.e2e-spec.ts >> US-079 Search and select a user when creating a manual reservation >> administrator searches for a user by email, name, and phone number and creates a manual reservation
- Location: e2e\us-079.e2e-spec.ts:4:3
