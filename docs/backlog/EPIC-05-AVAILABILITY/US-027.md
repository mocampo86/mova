...
As a user, I want to filter courts by sport.

## Functional description

This user story enables the user to filter courts by sport. It belongs to EPIC-05 — Public Availability and Discovery.

## Acceptance criteria

- [x] Filter courts by sport is implemented and available to the user.
...
`feature/US-027-filter-courts-by-sport`
