# US-050 — See how to list my complex

## Objective

As an owner, I want to see how to list my complex.

## Functional description

This user story enables the owner to see how to list my complex. It belongs to EPIC-09 — Landing Page and Public Site.

## Acceptance criteria

- [ ] See how to list my complex is implemented and available to the owner.
...
`feature/US-050-see-how-to-list-my-complex`

## Instructions for Devin

Implement the functionality that satisfies this user story for the owner.
