...
- [x] Assign one or more sports to a court is implemented and available to the administrator.
...
- Assignment endpoint: `PUT /api/v1/complexes/{complexId}/courts/{courtId}/sports`.
