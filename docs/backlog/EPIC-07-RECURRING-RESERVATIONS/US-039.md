...
- [ ] Cancel one occurrence without affecting the rest is implemented and available to the user or administrator.
...
- [ ] Cancelling an occurrence sets only that reservation and tracks who cancelled it.
